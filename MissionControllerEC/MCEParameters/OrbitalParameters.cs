...
namespace MissionControllerEC.MCEParameters
{
    ...
    public class ApAOrbitGoal : ContractParameter
    {
        ...
        {
            return "Enter " + OrbitType + " Around: " + targetBody.bodyName + "  With APA below: " + ApA.ToString("N0") + ". You have a margin of error of " + HighLogic.CurrentGame.Parameters.CustomParams<MCE_IntergratedSettings3>().MCEErrorOrbits.ToString("N0");
        }
        ...
        public void Orbits(Vessel vessel)
        {
            if (vessel.launchTime > this.Root.DateAccepted || HasBeNewVessel == false)
            {
                ...
                {
                    double minApA = ApA - HighLogic.CurrentGame.Parameters.CustomParams<MCE_IntergratedSettings3>().MCEErrorOrbits;
                    double maxApA = ApA + HighLogic.CurrentGame.Parameters.CustomParams<MCE_IntergratedSettings3>().MCEErrorOrbits;
    ...
    public class PeAOrbitGoal : ContractParameter
    {
        ...
        protected override string GetTitle()
        {
            return "Enter " + orbitType + " Around " + targetBody.bodyName + " With PeA above: " + PeA.ToString("N0") + ". You have a margin of error of " + HighLogic.CurrentGame.Parameters.CustomParams<MCE_IntergratedSettings3>().MCEErrorOrbits.ToString("N0");
        }
        ...
        public void Orbits(Vessel vessel)
        {
            if (vessel.launchTime > this.Root.DateAccepted || HasToBeNewVessel == false)
            {
                ...
                {
                    double minPeA = PeA - HighLogic.CurrentGame.Parameters.CustomParams<MCE_IntergratedSettings3>().MCEErrorOrbits;
                    double maxPeA = PeA + HighLogic.CurrentGame.Parameters.CustomParams<MCE_IntergratedSettings3>().MCEErrorOrbits;
    ...
    public class Inclination : ContractParameter
    {
        ...
        protected override string GetTitle()
        {
            return "Reach an inclination of: " + InclinationValue + ". You have a margin of error of " + HighLogic.CurrentGame.Parameters.CustomParams<MCE_IntergratedSettings3>().MCEErrorInclintation;
        }
        ...
        public void CheckInclination(Vessel vessel)
        {
            if (vessel.launchTime > this.Root.DateAccepted)
            {
                if (FlightGlobals.ActiveVessel)
                {
                    double maxInclination = InclinationValue + HighLogic.CurrentGame.Parameters.CustomParams<MCE_IntergratedSettings3>().MCEErrorInclintation;
                    double minInclination = InclinationValue - HighLogic.CurrentGame.Parameters.CustomParams<MCE_IntergratedSettings3>().MCEErrorInclintation;
    ...
    public class EccentricGoal : ContractParameter
    {
        ...
        public void CheckEccentricity(Vessel vessel)
        {
            if (vessel.launchTime > this.Root.DateAccepted)
            {
                double maxeccn = eccentricity + HighLogic.CurrentGame.Parameters.CustomParams<MCE_IntergratedSettings3>().MCEErrorEccentric;
                double mineccn = eccentricity - HighLogic.CurrentGame.Parameters.CustomParams<MCE_IntergratedSettings3>().MCEErrorEccentric;
